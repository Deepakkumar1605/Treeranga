# Generated by Django 5.0.7 on 2024-11-21 06:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('delivery_charge_per_bag', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('delivery_free_order_amount', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
            ],
        ),
        migrations.CreateModel(
            name='Products',
            fields=[
                ...
                ('product_for', models.CharField(blank=True, choices=[('Men', 'Men'), ('Women', 'Women'), ('Boy', 'Boy'), ('Girl', 'Girl')], default='Men', max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='product.products')),
            ],
        ),
        migrations.CreateModel(
            name='SimpleProduct',
